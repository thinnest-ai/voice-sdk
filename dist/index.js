...
var ThinnestVoice = class {
  ...
  setupRoomEvents() {
    ...
    this.room.on(import_livekit_client.RoomEvent.TrackUnsubscribed, (track) => {
      if (track.kind === import_livekit_client.Track.Kind.Audio) {
        this.emit("speech-end", {});
      }
    });
    this.room.on(import_livekit_client.RoomEvent.Disconnected, () => {
